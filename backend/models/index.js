...
db.HistoriqueActionsUtilisateur = require("./historiqueActionsUtilisateur.model")(sequelize, Sequelize);
...
db.Structure.hasMany(db.HistoriqueReconciliation, { foreignKey: "code_structure", sourceKey: "code_structure" });
db.HistoriqueReconciliation.belongsTo(db.Structure, { foreignKey: "code_structure", targetKey: "code_structure" });
...
db.Structure.hasMany(db.ArticlePanier, { foreignKey: "code_structure", sourceKey: "code_structure" });
db.ArticlePanier.belongsTo(db.Structure, { foreignKey: "code_structure", targetKey: "code_structure" });
