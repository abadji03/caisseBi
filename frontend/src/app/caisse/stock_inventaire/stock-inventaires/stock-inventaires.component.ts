...
export class StockInventairesComponent implements OnInit {
  ...
  magasins: Magasin[] = [
    new Magasin({
      ...
      ventes: [
        /* Liste de paniers correspondants à ce magasin */
      ],
      depenses: [
        /* Liste des dépenses pour ce magasin */
      ],
      recettes: [
        /* Liste des recettes pour ce magasin */
      ],
      statut: 'Actif',
      dateCreation: new Date('2023-01-01'),
      derniereMiseAJour: new Date('2025-03-01'),
      transferts: [
        /* Liste des transferts pour ce magasin */
      ],
      //stock: this.stocks
    }),
    new Magasin({
  ...
  stocks: Stock[] = [
    new Stock({
      ...
      stockSecurite: 5,
      dernierPrixAchat: 1500,
      dateDerniereMiseAJour: new Date('2025-03-01'),
      datePeremption: new Date('2025-12-01'),
    ...
    new Stock({
      ...
      quantiteReservee: 5,
      seuilAlerte: 5,
      seuilReapprovisionnement: 15,
      stockSecurite: 5,
      dernierPrixAchat: 2000,
      statutStock: 'En stock',
      datePeremption: new Date('2025-06-15'),
    }),
    new Stock({
      id: 3,
      produitId: 103,
    ...
    new Stock({
      ...
      stockSecurite: 5,
      dernierPrixAchat: 1200,
      statutStock: 'En stock',
      datePeremption: new Date('2025-08-01'),
    }),
    new Stock({
      id: 5,
      produitId: 105,
    ...
    new Stock({
      ...
      quantiteReservee: 15,
      seuilAlerte: 8,
      seuilReapprovisionnement: 25,
      stockSecurite: 5,
      dernierPrixAchat: 1800,
      statutStock: 'En stock',
    }),
    new Stock({
      id: 7,
      ...
      quantiteReservee: 30,
      seuilAlerte: 15,
      seuilReapprovisionnement: 40,
      stockSecurite: 10,
      dernierPrixAchat: 1400,
      statutStock: 'En stock',
    }),
    new Stock({
      id: 8,
    ...
    new Stock({
      ...
      stockSecurite: 2,
      dernierPrixAchat: 800,
      statutStock: 'Rupture',
      datePeremption: new Date('2025-04-20'),
    }),
    new Stock({
      id: 10,
      produitId: 110,
  ...
  mouvementsStock: MouvementsStock[] = [
    new MouvementsStock({
      ...
      dateMouvement: new Date('2025-03-08'),
    }),
    new MouvementsStock({
      id: 2,
      ref: 'MV-20250308-002',
    ...
    new MouvementsStock({
      ...
      dateMouvement: new Date('2025-03-07'),
    }),
    new MouvementsStock({
      id: 4,
      ref: 'MV-20250308-004',
      ...
      dateMouvement: new Date('2025-03-06'),
    }),
    new MouvementsStock({
      id: 5,
      ref: 'MV-20250308-005',
      ...
      prixUnitaire: 1200,
      acteurId: 2,
      description: 'Nouvelle livraison fournisseur',
      dateMouvement: new Date('2025-03-05'),
    }),
    ...
    new MouvementsStock({
      ...
      dateMouvement: new Date('2025-03-04'),
    }),
    new MouvementsStock({
      id: 8,
      ref: 'MV-20250308-008',
      ...
      prixUnitaire: 3000,
      acteurId: 7,
      description: 'Livraison client gros',
      dateMouvement: new Date('2025-03-03'),
    }),
    new MouvementsStock({
      id: 9,
      ref: 'MV-20250308-009',
      ...
      prixUnitaire: 900,
      acteurId: 8,
      description: 'Achat pour revente',
      dateMouvement: new Date('2025-03-02'),
    }),
    new MouvementsStock({
      id: 10,
      ref: 'MV-20250308-010',
      ...
      prixUnitaire: 1000,
      acteurId: 9,
      description: 'Stock boulangerie',
      dateMouvement: new Date('2025-03-01'),
    }),
  ];
  ...
  onSearchChange(objet: string): void {
    if (objet === 'inventaire' || objet === 'qteDisponible' || objet === 'niveauStock') {
      ...
      if (objet === 'niveauStock') {
        this.filteredNiveauStock = this.produits.filter(
          (produit) =>
            produit.designation.toLowerCase().includes(this.searchTerm.toLowerCase()) ||
            this.getNomMagasinByProduitId(produit.id!, this.stocks, this.magasins)
              .toLowerCase()
      ...
      if (objet === 'qteDisponible') {
        this.filteredQtesDisponibles = this.produits.filter(
          (produit) =>
            produit.designation.toLowerCase().includes(this.searchTerm.toLowerCase()) ||
