  ...
  loadCategories(): Categorie[] {
    return [
      ...
      new Categorie({
        id: 2,
        name: 'Salaire',
        description: 'Paiement des employés',
        type: 'DEPENSE',
        isActive: true,
      }),
      new Categorie({
      ...
      new Categorie({
        ...
        description: 'Revenus des investissements',
        type: 'RECETTE',
        isActive: true,
      }),
      new Categorie({
        id: 7,
        name: 'Services',
        description: 'Revenus des prestations de services',
        type: 'RECETTE',
        isActive: true,
      }),
      new Categorie({
        id: 8,
        name: 'Publicité',
        description: 'Dépenses en marketing',
        type: 'DEPENSE',
        isActive: true,
      }),
      new Categorie({
  ...
  loadDepenses(): Depense[] {
    return [
      new Depense({
        ...
        montant: 150000,
        type: 'STANDARD',
        description: 'Paiement du loyer de bureau',
      ...
      new Depense({
        ...
        montant: 200000,
        type: 'STANDARD',
        description: 'Salaire du personnel',
        paymentMode: 'Virement',
      }),
      new Depense({
        id: 3,
      ...
      new Depense({
        ...
        montant: 40000,
        type: 'STANDARD',
        description: 'Transport des marchandises',
        paymentMode: 'Espèce',
      }),
      new Depense({
        id: 7,
      ...
      new Depense({
        ...
        montant: 70000,
        type: 'STOCK',
        description: 'Achat de fournitures de production',
        paymentMode: 'Carte',
      }),
      new Depense({
        id: 9,
      ...
      new Depense({
        ...
        montant: 160000,
        type: 'STANDARD',
        description: 'Renouvellement de bail',
        paymentMode: 'Mobile Money',
      }),
    ];
  }
  ...
  loadRecettes(): Recette[] {
    return [
      ...
      new Recette({
        ...
        categoryId: 6,
        montant: 150000,
        description: 'Dividendes sur investissement',
        paymentMode: 'Virement',
      }),
      new Recette({
        id: 3,
      ...
      new Recette({
        ...
        categoryId: 7,
        montant: 95000,
        description: 'Maintenance de site web',
        paymentMode: 'Carte',
      }),
      new Recette({
        id: 10,
  ...
  loadPaiement(): Paiement[] {
    return [
      ...
      new Paiement({
        id: 3,
        numero: 'PAY-003',
        description: 'Paiement fournisseur C',
        montant: 200000,
        compte: 'Caisse',
        typePaiement: 'fournisseur',
        methodePaiement: 2,
      ...
      new Paiement({
        id: 5,
        numero: 'PAY-005',
        description: 'Paiement fournisseur E',
        montant: 125000,
        compte: 'Mobile Money',
        typePaiement: 'fournisseur',
        methodePaiement: 1,
      ...
      new Paiement({
        id: 6,
        numero: 'PAY-006',
        description: 'Remboursement client F',
        montant: 60000,
        compte: 'Banque',
        typePaiement: 'client',
        methodePaiement: 2,
      ...
      new Paiement({
        id: 7,
        numero: 'PAY-007',
        description: 'Paiement fournisseur G',
        montant: 95000,
        compte: 'Caisse',
        typePaiement: 'fournisseur',
        methodePaiement: 2,
      ...
      new Paiement({
        id: 9,
        numero: 'PAY-009',
        description: 'Paiement fournisseur I',
        montant: 300000,
        compte: 'Mobile Money',
        typePaiement: 'fournisseur',
        methodePaiement: 4,
