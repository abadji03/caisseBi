...
export const magasins: Magasin[] = [
  new Magasin({
    id: 1,
    nom: 'SuperMarket Paris',
    adresse: '12 Rue de la République',
    ville: 'Paris',
    telephone: '0145863254',
    email: 'paris@supermarket.com',
    responsableId: 101,
    capaciteStock: 5000,
  ...
  new Magasin({
    id: 2,
    nom: 'SuperMarket Lyon',
    adresse: '45 Avenue des Ternes',
    ville: 'Lyon',
    telephone: '0478563214',
    email: 'lyon@supermarket.com',
    responsableId: 102,
    capaciteStock: 3500,
    chiffreAffaires: 18000,
    statut: 'Actif',
    dateCreation: new Date('2022-03-20'),
  }),
  new Magasin({
    id: 3,
    nom: 'SuperMarket Marseille',
    adresse: '30 Boulevard Michelet',
    ville: 'Marseille',
    telephone: '0491326547',
    email: 'marseille@supermarket.com',
    responsableId: 103,
    capaciteStock: 4000,
    chiffreAffaires: 21000,
    statut: 'Inactif',
    dateCreation: new Date('2022-05-10'),
  }),
];
...
export const produits: Produits[] = [
  ...
  new Produits({
    id: 1,
    categorieId: 1,
    designation: 'Pâtes Barilla',
    unite: 'Kg',
    prixAchatUnitaire: 1.2,
    prixVenteUnitaire: 2.5,
    perissable: false,
  ...
  new Produits({
    ...
    unite: 'Bouteille',
    prixAchatUnitaire: 0.3,
    prixVenteUnitaire: 0.8,
    perissable: false,
  ...
  new Produits({
    id: 3,
    categorieId: 3,
    designation: 'Pommes Golden',
    unite: 'Kg',
    prixAchatUnitaire: 1.5,
    prixVenteUnitaire: 2.8,
    perissable: true,
  ...
  new Produits({
    id: 4,
    categorieId: 4,
    designation: 'Lait entier',
    unite: 'Litre',
    prixAchatUnitaire: 0.8,
  ...
  new Produits({
    ...
    unite: 'Pièce',
    prixAchatUnitaire: 0.6,
    prixVenteUnitaire: 1.2,
    perissable: true,
  ...
  new Produits({
    ...
    unite: 'Kg',
    prixAchatUnitaire: 8.5,
    prixVenteUnitaire: 12.0,
    perissable: true,
  ...
  new Produits({
    id: 7,
    categorieId: 5,
    designation: 'Cafetière',
    unite: 'Pièce',
    prixAchatUnitaire: 25.0,
    prixVenteUnitaire: 39.99,
    perissable: false,
  ...
  new Produits({
    id: 8,
    categorieId: 5,
    designation: 'Lessive 3L',
    unite: 'Bouteille',
    prixAchatUnitaire: 5.8,
    prixVenteUnitaire: 9.5,
    perissable: false,
  ...
  new Produits({
    id: 9,
    categorieId: 5,
    designation: 'Pizza 4 fromages',
    unite: 'Pièce',
    prixAchatUnitaire: 2.3,
    prixVenteUnitaire: 4.5,
    perissable: true,
    codeBarre: '901234567890',
  }),
  new Produits({
    id: 10,
    categorieId: 5,
    ...
    unite: 'Tube',
    prixAchatUnitaire: 1.1,
    prixVenteUnitaire: 2.2,
    perissable: false,
    codeBarre: '012345678901',
  }),
  ...
  new Produits({
    ...
    unite: 'Kg',
    prixAchatUnitaire: 1.8,
    prixVenteUnitaire: 3.2,
    perissable: false,
    codeBarre: '112345678901',
  }),
  new Produits({
    id: 12,
    categorieId: 5,
  ...
  new Produits({
    ...
    unite: 'Kg',
    prixAchatUnitaire: 1.2,
    prixVenteUnitaire: 2.3,
    perissable: true,
    codeBarre: '312345678901',
  }),
  new Produits({
    id: 14,
    categorieId: 5,
    ...
    unite: 'Pot',
    prixAchatUnitaire: 0.4,
    prixVenteUnitaire: 0.8,
    perissable: true,
    codeBarre: '412345678901',
  }),
  new Produits({
    id: 15,
    categorieId: 5,
    ...
    unite: 'Pièce',
    prixAchatUnitaire: 0.35,
    prixVenteUnitaire: 0.9,
    perissable: true,
    codeBarre: '512345678901',
  }),
  new Produits({
    id: 16,
    categorieId: 5,
    ...
    prixVenteUnitaire: 9.9,
    perissable: true,
    codeBarre: '612345678901',
  }),
  new Produits({
    id: 17,
    categorieId: 5,
    designation: 'Grille-pain',
    unite: 'Pièce',
    prixAchatUnitaire: 18.0,
    prixVenteUnitaire: 29.99,
    perissable: false,
    codeBarre: '712345678901',
  }),
  new Produits({
    id: 18,
    categorieId: 5,
    designation: 'Nettoyant sol',
    unite: 'Litre',
    prixAchatUnitaire: 3.5,
    prixVenteUnitaire: 6.2,
    perissable: false,
    codeBarre: '812345678901',
  }),
  new Produits({
    id: 19,
    categorieId: 5,
    designation: 'Lasagnes',
    unite: 'Pièce',
    prixAchatUnitaire: 2.8,
    prixVenteUnitaire: 5.2,
    perissable: true,
    codeBarre: '912345678901',
  }),
  new Produits({
    id: 20,
    categorieId: 5,
  ...
  new Produits({
    ...
    prixVenteUnitaire: 1.8,
    perissable: false,
    codeBarre: '122345678901',
  }),
  new Produits({
    id: 22,
    categorieId: 5,
    designation: 'Soda 1.5L',
    unite: 'Bouteille',
    prixAchatUnitaire: 0.8,
    prixVenteUnitaire: 1.9,
    perissable: false,
    codeBarre: '222345678901',
  }),
  new Produits({
    id: 23,
    categorieId: 5,
    designation: 'Oranges',
    unite: 'Kg',
    prixAchatUnitaire: 1.6,
    prixVenteUnitaire: 2.9,
    perissable: true,
    codeBarre: '322345678901',
  }),
  new Produits({
    id: 24,
    categorieId: 5,
    designation: 'Fromage râpé',
    unite: 'Kg',
    prixAchatUnitaire: 7.5,
    prixVenteUnitaire: 12.0,
    perissable: true,
    codeBarre: '422345678901',
  }),
  new Produits({
    id: 25,
    categorieId: 5,
    ...
    unite: 'Pièce',
    prixAchatUnitaire: 0.45,
    prixVenteUnitaire: 1.0,
    perissable: true,
    codeBarre: '522345678901',
  }),
  new Produits({
    id: 26,
    categorieId: 5,
    designation: 'Saumon frais',
    unite: 'Kg',
    prixAchatUnitaire: 12.0,
    prixVenteUnitaire: 18.5,
    perissable: true,
    codeBarre: '622345678901',
  }),
  new Produits({
    id: 27,
    categorieId: 5,
    designation: 'Bouilloire',
    unite: 'Pièce',
    prixAchatUnitaire: 15.0,
    prixVenteUnitaire: 24.99,
    perissable: false,
    codeBarre: '722345678901',
  }),
  new Produits({
    id: 28,
    categorieId: 5,
    designation: 'Désodorisant',
    unite: 'Spray',
    prixAchatUnitaire: 2.2,
    prixVenteUnitaire: 4.0,
    perissable: false,
    codeBarre: '822345678901',
  }),
  new Produits({
    id: 29,
    categorieId: 5,
    designation: 'Glace vanille',
    unite: 'Pot',
    prixAchatUnitaire: 2.5,
    prixVenteUnitaire: 4.8,
    perissable: true,
    codeBarre: '922345678901',
  }),
  new Produits({
    id: 30,
    categorieId: 5,
...
export const stocks: Stock[] = [
  ...
  new Stock({
    ...
    dernierPrixAchat: 1.5,
    prixVenteUnitaire: 2.8,
    datePeremption: new Date('2025-11-20'),
    statutStock: 'En stock',
    dateDerniereMiseAJour: new Date('2025-05-14'),
  }),
  new Stock({
    id: 4,
    produitId: 4,
    ...
    dernierPrixAchat: 0.8,
    prixVenteUnitaire: 1.5,
    datePeremption: new Date('2025-11-05'),
    statutStock: 'En stock',
    dateDerniereMiseAJour: new Date('2025-05-17'),
  }),
  new Stock({
    id: 5,
    produitId: 5,
    ...
    dernierPrixAchat: 0.6,
    prixVenteUnitaire: 1.2,
    datePeremption: new Date('2025-05-25'),
    statutStock: 'En stock',
    dateDerniereMiseAJour: new Date('2025-05-18'),
  }),
  new Stock({
    id: 6,
    produitId: 6,
    ...
    seuilAlerte: 5,
    seuilReapprovisionnement: 10,
    dernierPrixAchat: 8.5,
    prixVenteUnitaire: 12.0,
    datePeremption: new Date('2025-11-10'),
    statutStock: 'En stock',
    dateDerniereMiseAJour: new Date('2025-05-19'),
  }),
  new Stock({
    id: 7,
    produitId: 7,
  ...
  new Stock({
    ...
    seuilAlerte: 10,
    seuilReapprovisionnement: 15,
    dernierPrixAchat: 2.3,
    prixVenteUnitaire: 4.5,
    datePeremption: new Date('2024-02-15'),
    statutStock: 'En stock',
  ...
  new Stock({
    ...
    dernierPrixAchat: 1.2,
    prixVenteUnitaire: 2.5,
    datePeremption: new Date('2025-11-15'),
    statutStock: 'En stock',
    dateDerniereMiseAJour: new Date('2025-05-16'),
  }),
  new Stock({
    ...
    dernierPrixAchat: 1.2,
    prixVenteUnitaire: 2.3,
    datePeremption: new Date('2025-11-01'),
    statutStock: 'En stock',
    dateDerniereMiseAJour: new Date('2025-05-17'),
  }),
  new Stock({
  ...
  new Stock({
    ...
    seuilAlerte: 20,
    seuilReapprovisionnement: 30,
    dernierPrixAchat: 0.35,
    prixVenteUnitaire: 0.9,
    datePeremption: new Date('2025-05-28'),
    statutStock: 'En stock',
    dateDerniereMiseAJour: new Date('2025-05-19'),
  }),
  new Stock({
  ...
  new Stock({
    ...
    seuilAlerte: 10,
    seuilReapprovisionnement: 15,
    dernierPrixAchat: 2.8,
    prixVenteUnitaire: 5.2,
    datePeremption: new Date('2024-01-20'),
    statutStock: 'En stock',
    dateDerniereMiseAJour: new Date('2025-05-23'),
  }),
  new Stock({
  ...
  new Stock({
    ...
    seuilAlerte: 20,
    seuilReapprovisionnement: 30,
    dernierPrixAchat: 0.45,
    prixVenteUnitaire: 1.0,
    datePeremption: new Date('2025-05-30'),
    statutStock: 'En stock',
    dateDerniereMiseAJour: new Date('2025-05-19'),
  }),
  new Stock({
    ...
    seuilAlerte: 5,
    seuilReapprovisionnement: 10,
    dernierPrixAchat: 12.0,
    prixVenteUnitaire: 18.5,
    datePeremption: new Date('2025-11-08'),
    statutStock: 'En stock',
    dateDerniereMiseAJour: new Date('2025-05-20'),
  }),
  new Stock({
  ...
  new Stock({
    ...
    seuilAlerte: 5,
    seuilReapprovisionnement: 10,
    dernierPrixAchat: 2.5,
    prixVenteUnitaire: 4.8,
    datePeremption: new Date('2024-03-15'),
    statutStock: 'En stock',
    dateDerniereMiseAJour: new Date('2025-05-23'),
  }),
  new Stock({
...
export const mouvements: MouvementsStock[] = [
  ...
  new MouvementsStock({
    ...
    dateMouvement: new Date('2025-05-15'),
  }),
  new MouvementsStock({
    id: 2,
    ref: 'MV-PAR-2025-002',
  ...
  new MouvementsStock({
    ...
    dateMouvement: new Date('2025-05-16'),
  }),
  new MouvementsStock({
    id: 4,
    ref: 'MV-PAR-2025-004',
    ...
    prixUnitaire: 1.5,
    acteurId: 203,
    description: 'Livraison fruits',
    dateMouvement: new Date('2025-05-14'),
  }),
  new MouvementsStock({
    id: 5,
    ref: 'MV-PAR-2025-005',
    ...
    prixUnitaire: 0.8,
    acteurId: 204,
    description: 'Livraison laitage',
    dateMouvement: new Date('2025-05-17'),
  }),
  new MouvementsStock({
    id: 6,
    ref: 'MV-PAR-2025-006',
    ...
    prixUnitaire: 0.6,
    acteurId: 205,
    description: 'Livraison boulangerie',
    dateMouvement: new Date('2025-05-18'),
  }),
  new MouvementsStock({
    id: 7,
    ref: 'MV-PAR-2025-007',
    ...
    prixUnitaire: 8.5,
    acteurId: 206,
    description: 'Livraison viande',
    dateMouvement: new Date('2025-05-19'),
  }),
  new MouvementsStock({
    id: 8,
    ref: 'MV-PAR-2025-008',
    ...
    dateMouvement: new Date('2025-05-20'),
  }),
  new MouvementsStock({
    id: 9,
    ref: 'MV-PAR-2025-009',
    ...
    prixUnitaire: 5.8,
    acteurId: 208,
    description: 'Livraison entretien',
    dateMouvement: new Date('2025-05-21'),
  }),
  new MouvementsStock({
    id: 10,
    ref: 'MV-PAR-2025-050',
    ...
    prixUnitaire: 2.3,
    acteurId: 209,
    description: 'Livraison surgelés',
    dateMouvement: new Date('2025-05-22'),
  }),
  new MouvementsStock({
    id: 11,
    ref: 'MV-PAR-2025-051',
    ...
    prixUnitaire: 1.1,
    acteurId: 210,
    description: 'Livraison hygiène',
    dateMouvement: new Date('2025-05-23'),
  }),
  new MouvementsStock({
    id: 12,
    ref: 'MV-PAR-2025-052',
  ...
  new MouvementsStock({
    ...
    acteurId: 220,
    description: 'Livraison hygiène',
    dateMouvement: new Date('2025-05-24'),
  }),
  new MouvementsStock({
    id: 27,
    ref: 'MV-LYO-2025-052',
...
export const transferts: Transfert[] = [
  ...
  new Transfert({
    id: 1,
    reference: 'TRF-PAR-001',
    produitId: 1,
    quantite: 10,
    magasinSource: 1,
    magasinDestination: 2,
    dateTransfert: new Date('2025-05-05'),
    statut: 'Validé',
    agentResponsable: 401,
  }),
  new Transfert({
    id: 2,
    reference: 'TRF-PAR-002',
    produitId: 2,
    quantite: 20,
    magasinSource: 1,
    magasinDestination: 3,
    dateTransfert: new Date('2025-05-07'),
    statut: 'Validé',
    agentResponsable: 402,
  }),
  new Transfert({
    id: 3,
    reference: 'TRF-PAR-003',
    produitId: 3,
    quantite: 5,
    magasinSource: 1,
    magasinDestination: 2,
    dateTransfert: new Date('2025-05-09'),
    statut: 'En attente',
    agentResponsable: 403,
  }),
  new Transfert({
    id: 4,
    reference: 'TRF-PAR-004',
    produitId: 4,
    quantite: 8,
    magasinSource: 1,
    magasinDestination: 3,
    dateTransfert: new Date('2025-05-11'),
    statut: 'Refusé',
    motif: 'Stock insuffisant',
    agentResponsable: 404,
  }),
  new Transfert({
    id: 5,
    reference: 'TRF-PAR-005',
    produitId: 5,
    quantite: 15,
    magasinSource: 1,
    magasinDestination: 2,
    dateTransfert: new Date('2025-05-13'),
    statut: 'Validé',
    agentResponsable: 405,
  }),
  new Transfert({
    id: 6,
    reference: 'TRF-PAR-006',
    produitId: 6,
    quantite: 3,
    magasinSource: 1,
    magasinDestination: 3,
    dateTransfert: new Date('2025-05-15'),
    statut: 'Validé',
    agentResponsable: 406,
  }),
  new Transfert({
    id: 7,
    reference: 'TRF-PAR-007',
    produitId: 7,
    quantite: 2,
    magasinSource: 1,
    magasinDestination: 2,
    dateTransfert: new Date('2025-05-17'),
    statut: 'En attente',
    agentResponsable: 407,
  }),
  new Transfert({
    id: 8,
    reference: 'TRF-PAR-008',
    produitId: 8,
    quantite: 4,
    magasinSource: 1,
    magasinDestination: 3,
    dateTransfert: new Date('2025-05-19'),
    statut: 'Refusé',
    motif: 'Produit endommagé',
    agentResponsable: 408,
  }),
  new Transfert({
    id: 9,
    reference: 'TRF-PAR-009',
    produitId: 9,
    quantite: 6,
    magasinSource: 1,
    magasinDestination: 2,
    dateTransfert: new Date('2025-05-21'),
    statut: 'Validé',
    agentResponsable: 409,
  }),
  new Transfert({
    id: 10,
    reference: 'TRF-PAR-010',
    produitId: 10,
    quantite: 8,
    magasinSource: 1,
    magasinDestination: 3,
    dateTransfert: new Date('2025-05-23'),
    statut: 'Validé',
    agentResponsable: 410,
  }),
  new Transfert({
    id: 11,
    reference: 'TRF-PAR-011',
    produitId: 1,
    quantite: 5,
    magasinSource: 1,
    magasinDestination: 2,
    dateTransfert: new Date('2025-05-25'),
    statut: 'Validé',
    agentResponsable: 411,
  }),
  new Transfert({
    id: 12,
    reference: 'TRF-PAR-012',
    produitId: 2,
    quantite: 10,
    magasinSource: 1,
    magasinDestination: 3,
    dateTransfert: new Date('2025-05-27'),
    statut: 'En attente',
    agentResponsable: 412,
  }),
  new Transfert({
    id: 13,
    reference: 'TRF-PAR-013',
    produitId: 3,
    quantite: 4,
    magasinSource: 1,
    magasinDestination: 2,
    dateTransfert: new Date('2025-05-29'),
    statut: 'Validé',
    agentResponsable: 413,
  }),
  new Transfert({
    id: 14,
    reference: 'TRF-PAR-014',
    produitId: 4,
    quantite: 6,
    magasinSource: 1,
    magasinDestination: 3,
    dateTransfert: new Date('2025-05-31'),
    statut: 'Refusé',
    motif: 'Date péremption proche',
    agentResponsable: 414,
  }),
  new Transfert({
    id: 15,
    reference: 'TRF-PAR-015',
    produitId: 5,
    quantite: 12,
    magasinSource: 1,
    magasinDestination: 2,
    dateTransfert: new Date('2025-02-02'),
    statut: 'Validé',
    agentResponsable: 415,
  }),

  // Transferts depuis Magasin 2 (Lyon) - 15 transferts
  new Transfert({
    id: 16,
    reference: 'TRF-LYO-001',
    produitId: 11,
    quantite: 15,
    magasinSource: 2,
    magasinDestination: 1,
    dateTransfert: new Date('2025-05-06'),
    statut: 'Validé',
    agentResponsable: 416,
  }),
  new Transfert({
    id: 17,
    reference: 'TRF-LYO-002',
    produitId: 12,
    quantite: 10,
    magasinSource: 2,
    magasinDestination: 3,
    dateTransfert: new Date('2025-05-08'),
    statut: 'Validé',
    agentResponsable: 417,
  }),
  new Transfert({
    id: 18,
    reference: 'TRF-LYO-003',
    produitId: 13,
    quantite: 8,
    magasinSource: 2,
    magasinDestination: 1,
    dateTransfert: new Date('2025-05-10'),
    statut: 'En attente',
    agentResponsable: 418,
  }),
  new Transfert({
    id: 19,
    reference: 'TRF-LYO-004',
    produitId: 14,
    quantite: 12,
    magasinSource: 2,
    magasinDestination: 3,
    dateTransfert: new Date('2025-05-12'),
    statut: 'Refusé',
    motif: 'Stock critique',
    agentResponsable: 419,
  }),
  new Transfert({
    id: 20,
    reference: 'TRF-LYO-005',
    produitId: 15,
    quantite: 20,
    magasinSource: 2,
    magasinDestination: 1,
    dateTransfert: new Date('2025-05-14'),
    statut: 'Validé',
    agentResponsable: 420,
  }),
  new Transfert({
    id: 21,
    reference: 'TRF-LYO-006',
    produitId: 16,
    quantite: 5,
    magasinSource: 2,
    magasinDestination: 3,
    dateTransfert: new Date('2025-05-16'),
    statut: 'Validé',
    agentResponsable: 421,
  }),
  new Transfert({
    id: 22,
    reference: 'TRF-LYO-007',
    produitId: 17,
    quantite: 3,
    magasinSource: 2,
    magasinDestination: 1,
    dateTransfert: new Date('2025-05-18'),
    statut: 'En attente',
    agentResponsable: 422,
  }),
  new Transfert({
    id: 23,
    reference: 'TRF-LYO-008',
    produitId: 18,
    quantite: 6,
    magasinSource: 2,
    magasinDestination: 3,
    dateTransfert: new Date('2025-05-20'),
    statut: 'Refusé',
    motif: 'Emballage abîmé',
    agentResponsable: 423,
  }),
  new Transfert({
    id: 24,
    reference: 'TRF-LYO-009',
    produitId: 19,
    quantite: 10,
    magasinSource: 2,
    magasinDestination: 1,
    dateTransfert: new Date('2025-05-22'),
    statut: 'Validé',
    agentResponsable: 424,
  }),
  new Transfert({
    id: 25,
    reference: 'TRF-LYO-010',
    produitId: 20,
    quantite: 7,
    magasinSource: 2,
    magasinDestination: 3,
    dateTransfert: new Date('2025-05-24'),
    statut: 'Validé',
    agentResponsable: 425,
  }),
  new Transfert({
    id: 26,
    reference: 'TRF-LYO-011',
    produitId: 11,
    quantite: 8,
    magasinSource: 2,
    magasinDestination: 1,
    dateTransfert: new Date('2025-05-26'),
    statut: 'Validé',
    agentResponsable: 426,
  }),
  new Transfert({
    id: 27,
    reference: 'TRF-LYO-012',
    produitId: 12,
    quantite: 12,
    magasinSource: 2,
    magasinDestination: 3,
    dateTransfert: new Date('2025-05-28'),
    statut: 'En attente',
    agentResponsable: 427,
  }),
  new Transfert({
    id: 28,
    reference: 'TRF-LYO-013',
    produitId: 13,
    quantite: 5,
    magasinSource: 2,
    magasinDestination: 1,
    dateTransfert: new Date('2025-05-30'),
    statut: 'Validé',
    agentResponsable: 428,
  }),
  new Transfert({
    id: 29,
    reference: 'TRF-LYO-014',
    produitId: 14,
    quantite: 9,
    magasinSource: 2,
    magasinDestination: 3,
    dateTransfert: new Date('2025-02-01'),
    statut: 'Refusé',
    motif: 'Produit périmé',
    agentResponsable: 429,
  }),
  new Transfert({
    id: 30,
    reference: 'TRF-LYO-015',
    produitId: 15,
    quantite: 15,
    magasinSource: 2,
    magasinDestination: 1,
    dateTransfert: new Date('2025-02-03'),
    statut: 'Validé',
    agentResponsable: 430,
  }),

  // Transferts depuis Magasin 3 (Marseille) - 15 transferts
  new Transfert({
    id: 31,
    reference: 'TRF-MAR-001',
    produitId: 21,
    quantite: 12,
    magasinSource: 3,
    magasinDestination: 1,
    dateTransfert: new Date('2025-05-07'),
    statut: 'Validé',
    agentResponsable: 431,
  }),
  new Transfert({
    id: 32,
    reference: 'TRF-MAR-002',
    produitId: 22,
    quantite: 8,
    magasinSource: 3,
    magasinDestination: 2,
    dateTransfert: new Date('2025-05-09'),
    statut: 'Validé',
    agentResponsable: 432,
  }),
  new Transfert({
    id: 33,
    reference: 'TRF-MAR-003',
    produitId: 23,
    quantite: 6,
    magasinSource: 3,
    magasinDestination: 1,
    dateTransfert: new Date('2025-05-11'),
    statut: 'En attente',
    agentResponsable: 433,
  }),
  new Transfert({
    id: 34,
    reference: 'TRF-MAR-004',
    produitId: 24,
    quantite: 4,
    magasinSource: 3,
    magasinDestination: 2,
    ...
    statut: 'Refusé',
    motif: 'Stock réservé',
    agentResponsable: 434,
  }),
  new Transfert({
    id: 35,
    reference: 'TRF-MAR-005',
    produitId: 25,
    quantite: 18,
    magasinSource: 3,
    magasinDestination: 1,
    dateTransfert: new Date('2025-05-15'),
    statut: 'Validé',
    agentResponsable: 435,
  }),
  new Transfert({
    id: 36,
    reference: 'TRF-MAR-006',
    produitId: 26,
    quantite: 3,
    magasinSource: 3,
    magasinDestination: 2,
    dateTransfert: new Date('2025-05-17'),
    statut: 'Validé',
    agentResponsable: 436,
  }),
  new Transfert({
    id: 37,
    reference: 'TRF-MAR-007',
    produitId: 27,
    quantite: 2,
    magasinSource: 3,
    magasinDestination: 1,
    dateTransfert: new Date('2025-05-19'),
    statut: 'En attente',
    agentResponsable: 437,
  }),
  new Transfert({
    id: 38,
    reference: 'TRF-MAR-008',
    produitId: 28,
    quantite: 10,
    magasinSource: 3,
    magasinDestination: 2,
    ...
    agentResponsable: 438,
  }),
  new Transfert({
    id: 39,
    reference: 'TRF-MAR-009',
    produitId: 29,
    quantite: 7,
    magasinSource: 3,
    magasinDestination: 1,
    dateTransfert: new Date('2025-05-23'),
    statut: 'Validé',
    agentResponsable: 439,
  }),
  new Transfert({
    id: 40,
    reference: 'TRF-MAR-010',
    produitId: 30,
    quantite: 5,
    magasinSource: 3,
    magasinDestination: 2,
    dateTransfert: new Date('2025-05-25'),
    statut: 'Validé',
    agentResponsable: 440,
  }),
  new Transfert({
    id: 41,
    reference: 'TRF-MAR-011',
    produitId: 21,
    quantite: 9,
    magasinSource: 3,
    magasinDestination: 1,
    dateTransfert: new Date('2025-05-27'),
    statut: 'Validé',
    agentResponsable: 441,
  }),
  new Transfert({
    id: 42,
    reference: 'TRF-MAR-012',
    produitId: 22,
    quantite: 6,
    magasinSource: 3,
    magasinDestination: 2,
    dateTransfert: new Date('2025-05-29'),
    statut: 'En attente',
    agentResponsable: 442,
  }),
  new Transfert({
    id: 43,
    reference: 'TRF-MAR-013',
    produitId: 23,
    quantite: 5,
    magasinSource: 3,
    magasinDestination: 1,
    dateTransfert: new Date('2025-05-31'),
    statut: 'Validé',
    agentResponsable: 443,
  }),
  new Transfert({
    id: 44,
    reference: 'TRF-MAR-014',
    produitId: 24,
    quantite: 3,
    magasinSource: 3,
    magasinDestination: 2,
    dateTransfert: new Date('2025-02-02'),
    statut: 'Refusé',
    motif: 'Quantité insuffisante',
    agentResponsable: 444,
  }),
  new Transfert({
    id: 45,
    reference: 'TRF-MAR-015',
    produitId: 25,
    quantite: 12,
    magasinSource: 3,
    magasinDestination: 1,
    dateTransfert: new Date('2025-02-04'),
    statut: 'Validé',
    agentResponsable: 445,
  }),
];
export const depenses: Depense[] = [
  ...
  new Depense({
    ...
    montant: 1200.0,
    type: 'STOCK',
    description: 'Achat pâtes Barilla',
  ...
  new Depense({
    ...
    montant: 450.5,
    type: 'STANDARD',
    description: 'Entretien camion livraison',
    paymentMode: 'Chèque',
    magasinId: 1,
  }),
  new Depense({
  ...
  new Depense({
    ...
    montant: 1650.0,
    type: 'STOCK',
    description: 'Achat fruits et légumes',
    paymentMode: 'Virement',
    magasinId: 1,
  }),
  new Depense({
    ...
    montant: 850.0,
    type: 'STOCK',
    description: 'Achat produits surgelés',
    paymentMode: 'Virement',
    magasinId: 1,
  }),
  new Depense({
    ...
    montant: 320.75,
    type: 'STANDARD',
    description: 'Matériel de caisse',
    paymentMode: 'Carte',
    magasinId: 1,
  }),
  new Depense({
    ...
    montant: 280.0,
    type: 'STANDARD',
    description: 'Formation employés',
    paymentMode: 'Chèque',
    magasinId: 1,
  }),
  new Depense({
    ...
    montant: 1350.0,
    type: 'STOCK',
    description: 'Achat produits bio',
    paymentMode: 'Virement',
    magasinId: 1,
  }),
  new Depense({
    ...
    montant: 175.5,
    type: 'STANDARD',
    description: 'Réparation chariot',
    paymentMode: 'Espèces',
    magasinId: 1,
  }),
  new Depense({
    ...
    montant: 920.0,
    type: 'STOCK',
    description: 'Achat produits secs',
    paymentMode: 'Virement',
    magasinId: 1,
  }),
  ...
  new Depense({
    ...
    montant: 1250.0,
    type: 'STOCK',
    description: 'Achat produits boulangerie',
    paymentMode: 'Virement',
    magasinId: 2,
  }),
  ...
  new Depense({
    ...
    montant: 950.0,
    type: 'STOCK',
    description: 'Achat produits laitiers',
    paymentMode: 'Virement',
    magasinId: 3,
  }),
  new Depense({
  ...
  new Depense({
    ...
    montant: 290.0,
    type: 'STANDARD',
    description: 'Uniforme personnel',
    paymentMode: 'Chèque',
    magasinId: 3,
  }),
  new Depense({
  ...
  new Depense({
    ...
    montant: 1350.0,
    type: 'STOCK',
    description: 'Achat fruits exotiques',
    paymentMode: 'Virement',
    magasinId: 3,
  }),
  new Depense({
    ...
    montant: 350.0,
    type: 'STANDARD',
    description: 'Décorations saisonnières',
    paymentMode: 'Espèces',
    magasinId: 3,
  }),
  new Depense({
  ...
  new Depense({
    ...
    montant: 2200.0,
    type: 'STOCK',
    description: 'Achat vins et spiritueux',
    paymentMode: 'Virement',
    magasinId: 3,
  }),
];
...
export const recettes: Recette[] = [
  ...
  new Recette({
    ...
    categoryId: 101,
    montant: 4200.0,
    description: 'Vente weekend produits alimentaires',
    paymentMode: 'Mixte',
    magasinId: 1,
  }),
  new Recette({
    ...
    categoryId: 102,
    montant: 3800.25,
    description: 'Vente promotion printemps',
    paymentMode: 'Mixte',
    magasinId: 1,
  }),
  new Recette({
    ...
    categoryId: 102,
    montant: 3650.5,
    description: 'Promotion spéciale clients fidèles',
    paymentMode: 'Mixte',
    magasinId: 1,
  }),
  new Recette({
    ...
    categoryId: 103,
    montant: 4100.0,
    description: 'Soirée gastronomique',
    paymentMode: 'Mixte',
    magasinId: 1,
  }),
  new Recette({
    ...
    categoryId: 101,
    montant: 3200.75,
    description: 'Vente quotidienne alimentaire',
    paymentMode: 'Mixte',
    magasinId: 1,
  }),
  new Recette({
    ...
    categoryId: 103,
    montant: 2850.5,
    description: 'Événement vin fromage',
    paymentMode: 'Mixte',
    magasinId: 1,
  }),
  new Recette({
    ...
    categoryId: 105,
    montant: 3950.0,
    description: 'Service traiteur entreprise',
    paymentMode: 'Virement',
    magasinId: 1,
  }),
  new Recette({
    ...
    categoryId: 101,
    montant: 2750.25,
    description: 'Vente produits bio',
    paymentMode: 'Mixte',
    magasinId: 1,
  }),
  new Recette({
    ...
    categoryId: 104,
    montant: 4300.0,
    description: 'Subvention mairie Paris',
    paymentMode: 'Virement',
    magasinId: 1,
  }),
  ...
  new Recette({
    ...
    categoryId: 101,
    montant: 2800.5,
    description: 'Vente produits régionaux',
    paymentMode: 'Mixte',
    magasinId: 2,
  }),
  new Recette({
    ...
    categoryId: 102,
    montant: 3100.75,
    description: 'Promotion produits lyonnais',
    paymentMode: 'Mixte',
    magasinId: 2,
  }),
  new Recette({
  ...
  new Recette({
    ...
    categoryId: 105,
    montant: 3050.75,
    description: 'Service livraison entreprises',
    paymentMode: 'Virement',
    magasinId: 2,
  }),
  new Recette({
  ...
  new Recette({
    ...
    categoryId: 104,
    montant: 3300.0,
    description: 'Aide région Rhône-Alpes',
    paymentMode: 'Virement',
    magasinId: 2,
  }),
  ...
  new Recette({
    ...
    categoryId: 101,
    montant: 1950.25,
    description: 'Vente produits méditerranéens',
    paymentMode: 'Mixte',
    magasinId: 3,
  }),
  new Recette({
    ...
    categoryId: 102,
    montant: 2450.5,
    description: 'Promotion poissons',
    paymentMode: 'Mixte',
    magasinId: 3,
  }),
  new Recette({
  ...
  new Recette({
    ...
    categoryId: 102,
    montant: 2300.0,
    description: "Promotion huiles d'olive",
    paymentMode: 'Mixte',
    magasinId: 3,
  }),
  new Recette({
    ...
    categoryId: 101,
    montant: 1850.5,
    description: 'Vente épicerie fine',
    paymentMode: 'Mixte',
    magasinId: 3,
  }),
  new Recette({
    ...
    categoryId: 105,
    montant: 2000.75,
    description: 'Service plateau-repas',
    paymentMode: 'Carte',
    magasinId: 3,
  }),
  new Recette({
    ...
    categoryId: 103,
    montant: 2550.0,
    description: 'Animation produits locaux',
    paymentMode: 'Mixte',
    magasinId: 3,
  }),
  new Recette({
  ...
  new Recette({
    ...
    categoryId: 102,
    montant: 1750.25,
    description: 'Promotion de fin mois',
    paymentMode: 'Mixte',
    magasinId: 3,
  }),
  new Recette({
    ...
    categoryId: 104,
    montant: 2250.0,
    description: 'Subvention ville Marseille',
    paymentMode: 'Virement',
    magasinId: 3,
  }),
];
